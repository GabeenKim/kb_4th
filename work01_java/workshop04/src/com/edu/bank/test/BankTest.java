...
public class BankTest {
	...
	public static void main(String[] args) {
		...
		while(true) {
			System.out.println("1.고객 등록    2.계좌생성    3.은행업무    4.고객전체명단    5.특정고객정보    6.나가기	 7.고객 삭제하기");
			int num = sc.nextInt();
	...
	public static void deleteCustomer() {
		System.out.print("삭제하고 싶은 고객의 주민번호를 입력하시오 : ");
		
		Scanner sc = new Scanner(System.in);
		int rrn = sc.nextInt();
	
		if(bank.getCustomer(rrn).getName() != "") {
			bank.deleteCustomer(rrn);
	...
	public static void addAccount() {
		...
		int balance = 0;
		if(bank.getCustomer(rrn)!=null && bank.getCustomer(rrn).getName() != "") {
