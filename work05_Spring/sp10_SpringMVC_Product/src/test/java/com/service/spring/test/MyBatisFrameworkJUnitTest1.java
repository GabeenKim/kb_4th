...
public class MyBatisFrameworkJUnitTest1 {	
	...
	public void unit() throws Exception{
		...
		MyProduct vo =new MyProduct("그냥 세탁기", "대우", 600000);
		...
		System.out.println("\n========2. findProducts ==============");
		List<MyProduct> list = ssession.selectList("ns.sql.MyProductMapper.findProduct");
		for(MyProduct prduct : list)
			System.out.println(prduct);
		
		
		System.out.println("\n========3. findProductByName ==============");
		List<MyProduct> list2 = ssession.selectList("ns.sql.MyProductMapper.findProduct",vo);
		for(MyProduct prduct : list2)
			System.out.println(prduct);
		
		System.out.println("\n========4. findProductByMaker ==============");
		List<MyProduct> list3 = ssession.selectList("ns.sql.MyProductMapper.findProduct",vo);
