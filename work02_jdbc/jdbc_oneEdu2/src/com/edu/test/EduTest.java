...
public class EduTest {
	...
	public static void main(String[] args) throws Exception {
		...
		Lecture lecture = service.findLectureById(3);
...
//		service.addLecture(new Lecture(6, "영어회화", "영어", 0, "90000"));
...
//		Lecture lec = new Lecture(21, "영어회화", "영어", 0, "90000");
